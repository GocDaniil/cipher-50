...
class DecryptText:
 ...
 "Ь", "Э", "Ю", "Я"]
        ...
        self.tables = {
            ...
            5: ["XISZU", "WRHTC", "OF6NQ", "RD648", "9CJON", "WCVW3",
            ...
            6: ["IDLQ5V", "5CLCZZ", "THG77K", "20CQPG", "HNR399",
            ...
            7: ["F8B9MFZ", "UZGLA96", "OH915T8", "7QWGEK2", "FA5TJQB",
            ...
            8: ["X73H3SRO", "P3KFMOSN", "O6ATYS6Q", "7Q8CZRSG",
            ...
            9: ["UTPK9IFBO", "WXJFV6Z4Q", "008PPGU5S", "6QGXOGKG4",
            ...
            10: ["7J9T3WFGQX", "R5PNOZDKYH", "VBG3XQ04AU", "XQJEMTL56D",
            ...
            11: ["UL7ZVRTFXG", "J92MKLHD0B", "TYXGAPFZVR",
            ...
            12: ["RPLTGU3XJQ", "W9KXFYMHP8", "TYL3BVRMCU",
            ...
            13: ["D7PKT1JXAG", "XCBRV9KLUG", "9LJTACUMWG",
            ...
            14: ['8H1ZO7TABM', 'MPCQRPLL73', 'N5YV35EY9Y', 'QEGGRZ9WD7', 'C1ILZWCJGH',
            ...
            15: ["ZKPXVGUMJT", "QGYZKJXUMP", "MKJXZUVRAG",
            ...
            16: ["5VX8YZ0AB3", "KL2MN5PQ8S", "Y7ZA0CD3FG",
            ...
            17: ["DB7F8B3897", "A3AD96671A", "CDE7F2E98E",
            ...
            18: ["B861E106D2", "9C9639A05D", "B23A95F8C6",
            ...
            19: ["FAB47F472A", "2F71C848BC", "5CE2EBE55E",
            ...
            20: ["7A0AB9C187", "E6B48B2352", "D0D24FA748",
            ...
            21: ["540CF3750B", "BF7D48A055", "0D9A010393",
            ...
            22: ["1B03ED4E4A", "4248304659", "BAD546F62F",
            ...
            23: ["45BCEB2F34", "7CADB15052", "B6639CA4A1",
            ...
            24: ["9E46F56A7A", "B7AD11BCE9", "C89632218C",
            ...
            25: ["B5077B18E3", "9B3847256D", "DABDD414EC",
            ...
            26: ["D29AE14A15", "9BFDAF97C4", "529138FBC0",
            ...
            27: ["904B6501B7", "13655434F7", "0ADCFDBE17",
            ...
            28: ["304D6F42E6", "08C70C5C53", "7016F88153",
            ...
            29: ["D5B050FD70", "963BFE773F", "ECBBCDCAF5",
            ...
            30: ["6DAAA01AD3", "F1E649D0DF", "314C963144",
            ...
            31: ["CFF74D2BB5", "04FCE0A414", "AC1A80AF7E",
            ...
            32: ['YJLOCUCJ75', 'DV1T8LNA6T', '9VQNWBYKGY',
            ...
            33: ['FPGHLSBGDX', '1LLSTGRZC2', 'J4PKT3Y48O',
            ...
            34: ['L78UCNE008', 'JBJG09LSAY', '2R06E9KP82',
            ...
            35: ["JWK14B8OKV", "3MKUPY461I", "ZQCD9572IS",
            ...
            36: ["5BIGY50DHN", "SI7339V3JQ", "I5N7NHHBX0",
            ...
            37: ["6UKA2VOSCQ", "5Z8I8JL6U4", "0VQ63ILP8F",
            ...
            38: ["MSPA57ALEG", "VNWU06HTG1", "Z51GKSL1ND",
            ...
            39: ["ZHR355J5TS", "4I2RVXRDBP", "6ZENWEEU63",
            ...
            40: ["F8NGHF5P7T", "GQZ5QZXXDS", "3F7MNZNWZZ",
            ...
            41: ["77AQH6RWYM", "V7JZEKZ6C3", "QNFRSVC4J4",
            ...
            42: ["W7WEJZJYUK", "C237NPQS9S", "KHEXKN7H3F",
            ...
            43: ["4YNLGLUP9Q", "WYMTYXWC9F", "XWVD3T2VC7",
            ...
            44: ["LYV9C4LUPR", "JJNW2REM6D", "DNRL6MLRW4",
            ...
            45: ["7G7P47RX9H", "KXA4L67RJC", "J794WVTSP5",
            ...
            46: ["U2ANLGCHFA", "X74LXVJZ2P", "DSWHC6NMH6",
            ...
            47: ["GWZAPV5AZP", "ARRPB5EJ7M", "PZUSLH3NAX",
            ...
            48: ["GF76ZDHQW3", "4DZE7KQR6W", "LD7WSBHZXH",
            ...
            49: ["HEJMG5U9SN", "GN5FYH8FB8", "BTF9WXGKW9",
            ...
            50: ["VBKQ6PQGUI", "A4HLM8W9GU", "08PDVH4YDX",
        ...
        self.shift_cycle = [13, -8, 21, -34, 47, 6, -15, 28, -9]
    ...
    def decode_length(self, encoded: str) -> int:

        if len(encoded) % 2 != 0:
            raise ValueError("Некорректная длинна закодированной длины")

        digits = []
        for i in range(0, len(encoded), 2):
            pair = encoded[i:i + 2]
            digit = self.digital_length_map.get(pair)

            if digit is None:
                raise ValueError("Ошибка при декодировании длины")

            digits.append(digit)

        return int("".join(digits))

    def decode_space_positions(self, encoded_str: str) -> list[int]:

        digits = [encoded_str[i:i+3] for i in range(0, len(encoded_str), 3)]
        positions = []
        current_num = ""

        for d in digits:
            digit = self.dict_space_positions.get(d)

            if digit is None:
                raise ValueError(f"Ошибка декодирования позиций пробелов")

            current_num += digit
            positions.append(int(current_num))
            current_num = ""

        return positions

    def get_table_num(self, rus_index: int) -> int:
        ...
        shift = self.shift_cycle[block % len(self.shift_cycle)]
    ...
    def decrypt(self, encrypted_text):
        ...
        length_encoded = parts[0]
        decoded_space_positions = self.decode_space_positions(parts[-1])

        try:
            russian_count = self.decode_length(length_encoded)
        ...
        if len(parts) == 2:
            ...
            encrypted_parts = parts[1:-1]

        encrypted_str = "".join(encrypted_parts).replace(" ", "").strip()

        if russian_count > 10:

            progressive_length = 10 * 11 // 2
            fixed_length = max(0, russian_count - 10) * 10
            expected_length = progressive_length + fixed_length

        else:

            expected_length = russian_count * (russian_count + 1) // 2

        if len(encrypted_str) != expected_length:
            raise ValueError("Неверная длина текста")

        start_index = 0

        decrypted_chars = []

        for i in range(1, russian_count + 1):

            token_length = i if i <= 10 else 10

            token = encrypted_str[start_index:start_index + token_length]
            start_index += token_length

            if i <= 50:
                table = self.tables.get(i)

            else:
                shift_index = ((i - 51) // 50) % len(self.shift_cycle)
                shift = self.shift_cycle[shift_index]

                table_num = 1 + ((i - 51) + shift) % len(self.tables)
                table = self.tables.get(table_num)

            if table is None:
                raise ValueError("Внутренняя ошибка дешифровки")

            try:
                token_upper = token.upper()
                index = table.index(token_upper)

            except ValueError:
                raise ValueError(f"Внутренняя ошибка дешифровки")

            if token.islower():

                decrypted_char = self.rus_alphabet_lower[index]

            elif token.isupper():
                decrypted_char = self.rus_alphabet_upper[index]
        ...
        for pos in decoded_space_positions:
            if 0 <= pos <= len(decrypted_chars):
                decrypted_chars.insert(pos," ")

        return ''.join(decrypted_chars)

def decrypt_main(text: str) -> str:

    try:
        decrypt_text = DecryptText(text)
        return decrypt_text.decrypt(text)
